export const RESUME_DATA = {
  ...
  experience: [
    ...
    },
    {
      ...
      location: 'Sao Paulo, Brazil',
      description:
        'Delivered enterprise solutions across banking, payments, and digital channels, covering architecture, integration, and full-stack implementation.',
      highlights: [
    ...
    },
    {
      ...
      location: 'Sao Paulo, Brazil',
      description:
        "Cared for and evolved Safra Home Broker, the bank's online stock trading platform.",
      highlights: [
    ...
    },
    {
      ...
      location: 'Sao Paulo, Brazil',
      description:
        'Developed CRM software integrated with Telco and CTI solutions for enterprise clients.',
      highlights: [
    ...
    },
    {
      ...
      location: 'Sao Paulo, Brazil',
      description:
        'Built a financial product simulation tool focused on loans and investment scenarios.',
      highlights: [
    ...
    },
    {
      ...
      location: 'Sao Paulo, Brazil',
      description:
        'Created brands, logos, websites, and e-commerce platforms for client campaigns.',
      highlights: [
